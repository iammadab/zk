...
/// Same as the sumcheck_old proof without the initial poly
...
/// Represents the result of a partial sumcheck_old proof verification
...
impl Sumcheck {
    ...
    /// Generates a sumcheck_old proof that makes no statement about the initial poly
    ...
    /// Verify partial sumcheck_old proof
